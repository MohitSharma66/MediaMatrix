  ...
  return (
    <div className='contact-cont' id="contact">
        <div className="ecell-section contact-section">
            ...
            <p style={{color: "white",}}>The most important thing in communication is to hear what isn't beign said. So come connect with us and share your reviews and ideas.</p>
            <div className="socials">
                <br></br>
                {/* <FacebookRoundedIcon sx={{color: "aqua", fontSize:"1.8rem"}}/>
                &nbsp; */}
                &nbsp;
                <a href="https://www.instagram.com/mediamatrix_iiitnr/?locale=tiny%2Bapk%E3%80%90GB999.BET%E3%80%91.xwur&hl=en"><InstagramIcon sx={{color: "white", fontSize:"1.8rem"}}/></a>
                &nbsp;
            </div>
        </div>
        <div className="quick-section contact-section">
            ...
            <div className="links">
                ...
                <ArrowForwardIcon sx={{color: "white", fontSize:"1.5rem"}}/>
                &nbsp;
                <Link to="/cryptic">Cryptic Hunt</Link>
                </div>
                {/* <div className="link">
        ...
        <div className="contact-section contact-section">
            ...
            <div className="contacts">
                ...
                <a href="mailto:mediamatrix@iiitnr.edu.in"><div className="contact-info"><MailIcon sx={{color: "white", cursor:"pointer"}}/>&nbsp;&nbsp;mediamatrix@iiitnr.edu.in</div></a>
            </div>
        </div>
    </div>
  )
