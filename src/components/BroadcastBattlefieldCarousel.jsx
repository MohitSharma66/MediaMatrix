        ...
        <div className="carousel-inner">
          <div className="carousel-item active d-flex" style={{ background: 'linear-gradient(120deg, #300000 0%, #700000 50%, #300000 100%)', width: '70em', height: '25rem' }}>
            ...
            <div className="d-flex flex-column align-items-start" style={{ paddingLeft: '2rem', textAlign: 'left' }}>
              ...
              <p style={{ color: '#fff', fontSize: '1.2rem' }}>Teams of three will participate in a dynamic three-round competition, showcasing innovative business ideas and entrepreneurial spirit. Participants will submit detailed written pitches, followed by an elevator pitch, and finally a live pitch to judges.</p>
              <p style={{ color: '#fff', fontSize: '1rem' }}>Date - 9th November</p>
              <p style={{ color: '#fff', fontSize: '1rem' }}>Registration Fee: ₹250 per person</p>
              <p style={{ color: '#fff', fontSize: '1rem' }}>Prize Pool: ₹6000</p>
              <p style={{ color: '#fff', fontSize: '1rem' }}>For details Contact</p>
              <p style={{ color: '#fff', fontSize: '1rem' }}>Thakur Mahima Nuruti - 8817233661</p>
            </div>
          </div>
